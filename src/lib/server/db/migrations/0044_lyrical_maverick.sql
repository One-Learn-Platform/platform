...
INSERT INTO `__new_schedule`("subject_id", "classroom_id", "period_start", "period_end", "day_of_week", "start_time", "end_time", "school_id") SELECT "subject_id", "classroom_id", "period_start", "period_end", "day_of_week", "start_time", "end_time", "school_id" FROM `schedule`;--> statement-breakpoint
