...
INSERT INTO `__new_assignment`("assignment_id", "chapter", "subject_id", "title", "description", "attachment", "quiz", "start_date", "limit_user", "due_date", "school_id", "created_at") SELECT "assignment_id", "chapter", "subject_id", "title", "description", "attachment", "quiz", "start_date", "limit_user", "due_date", "school_id", "created_at" FROM `assignment`;--> statement-breakpoint
