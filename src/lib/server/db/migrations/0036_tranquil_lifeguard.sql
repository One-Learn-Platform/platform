...
INSERT INTO `__new_subject`("subject_id", "subject_code", "grades_id", "teacher_id", "name", "subject_type_id", "chapter_count", "school_id") SELECT "subject_id", "subject_code", "grades_id", "teacher_id", "name", "subject_type_id", "chapter_count", "school_id" FROM `subject`;--> statement-breakpoint
