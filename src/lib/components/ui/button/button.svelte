	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				outline:
					"border bg-transparent text-primary shadow-xs hover:bg-primary/10 hover:text-accent-foreground dark:border-input dark:bg-input/30 dark:hover:bg-input/50",
