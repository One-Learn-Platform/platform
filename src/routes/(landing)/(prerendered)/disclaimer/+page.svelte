...
<svelte:head>
	<title>One Learn - Disclaimer</title>
</svelte:head>

<main class="min-h-dvh space-y-1 px-4 py-12 sm:px-12 md:px-16 lg:px-20 xl:px-24">
	<div class="py-8 sm:py-12">
		<h1 class="text-5xl font-medium tracking-tight">Disclaimer</h1>
		<Separator />
	</div>
