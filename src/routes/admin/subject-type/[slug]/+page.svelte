...
<div class="space-y-2 pr-2 pb-2">
	<h1 class="font-display text-3xl font-semibold tracking-tight">Subject Type Detail</h1>
	<Card.Root id="edit">
		<Card.Header>
			<Card.Title class="font-display">Edit Subject Type</Card.Title>
		</Card.Header>
		<form
			method="POST"
			...
			<Card.Content class="space-y-2">
				<Form.Field form={superform} name="name">
					...
					{#if $errors.name}
						<Form.FieldErrors />
					{:else}
						<Form.Description>Name of the subject type to be displayed.</Form.Description>
					{/if}
				</Form.Field>
			</Card.Content>
